...
CSRF_COOKIE_SECURE = True  # Set to True for production use

# (Optional) Also enforce HTTPS for session cookies
SESSION_COOKIE_SECURE = True  # Set to True for production use
