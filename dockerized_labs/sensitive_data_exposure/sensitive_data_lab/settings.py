...
CSRF_COOKIE_SECURE = True     # (Optional) Ensures that CSRF cookies are only sent over HTTPS
SECURE_SSL_REDIRECT = True    # (Optional) Redirects all HTTP traffic to HTTPS
